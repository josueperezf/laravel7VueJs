...
<!-- para hacer log logs https://github.com/rap2hpoutre/laravel-log-viewer-->
    <div class="container">
        ...
        <div class="mt-5 row justify-content-center ">
            <form action="{{route('establecimiento.update', ['establecimiento'=>$establecimiento->id])}}" class="col-md-9 col-xs-12 card card-body" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <fieldset class="border p-4 mt-5" >
                    ...
                    <input type="hidden" name="latitud" id="latitud" value="{{$establecimiento->latitud }}">
                    <input type="hidden" name="longitud" id="longitud" value="{{$establecimiento->longitud }}">
                </fieldset>
                <fieldset class="border p-4 mt-5">
                    <legend  class="text-primary">Información Establecimiento: </legend>
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                id="apertura"
                                name="apertura"
                                value="{{ date('h:i', strtotime($establecimiento->apertura)) }}"
                            >
                            @error('apertura')
                                <div class="invalid-feedback">
                                    {{$message}}
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                id="cierre"
                                name="cierre"
                                value="{{ date('h:i', strtotime($establecimiento->cierre)) }}"
                            >
                            @error('cierre')
                                <div class="invalid-feedback">
                                    {{$message}}
                ...
                <button type="submit" class="btn btn-primary mt-3 d-block"> Guardar Cambios</button>
            </form>
        </div>
    </div>
    @section('scripts')
