...
<div class="container mx-auto max-w-screen-md ">
    <div class="flex flex-wrap justify-center">
        <!-- con la siguiente linea se dice que en monitores normales primero muestre la siguiente, y luego la ultima, con el order-2 le decimos que en telefono, esta seccion la coloque de segunda-->
            ...
            <div class="w-full max-w-sm">
                <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                    <div class="bg-gray-300 text-gray-700 uppercase text-center py-3 px-6 mb-0">
                        <!-- la siguiente linea lo que hace es que busca traduccion si existe del siguiente string Login-->
                        {{  __('Register')}}
                    </div> 
                    <form class="py-10 px-5" novalidate  method="POST" action="{{ route('register') }}">
                        @csrf        
        ...
        <div class="md:w-1/2 order-1 md:order-1 text-center flex flex-col justify-center px-10 mt-10 ">
            ...
            <p class="text-xl mt-5 leading-7"> Crea una cuenta totalmente gratis </p>
        </div>
    </div>
</div>
@endsection
